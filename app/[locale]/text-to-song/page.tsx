...
const pageKey = "textToSong";
const pagePath = SEO_TOOL_PAGE_PATHS[pageKey];

export async function generateMetadata({
  params,
}: TextToSongPageProps): Promise<Metadata> {
...
export default async function TextToSongPage({ params }: TextToSongPageProps) {
  ...
  const createHref = "/create?mode=text";
  const pricingHref = "/pricing";
  const benefitKeys = ["ideas", "vocals", "creators"] as const;
  const stepKeys = ["prompt", "style", "create"] as const;
